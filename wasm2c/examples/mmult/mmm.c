...
static void init_memories(w2c_mmm* instance) {
}

/* export: 'mmm' */
void w2c_mmm_mmm(w2c_mmm* instance) {
#if WASM_RT_USE_SEGUE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  w2c_mmm_mmm_0(instance);
#if WASM_RT_USE_SEGUE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_mmm* instance, struct w2c_host* w2c_host_instance) {
  instance->w2c_host_instance = w2c_host_instance;
  instance->w2c_host_mem = w2c_host_mem(w2c_host_instance);
}

const u64 wasm2c_mmm_min_host_mem = 1;
const u64 wasm2c_mmm_max_host_mem = 65536;
const u8 wasm2c_mmm_is64_host_mem = 0;

void wasm2c_mmm_instantiate(w2c_mmm* instance, struct w2c_host* w2c_host_instance) {
...
void wasm2c_mmm_free(w2c_mmm* instance) {
}
  ...
  var_L1: 
    ...
    var_L4: 
      ...
      var_L7: 
        ...
        fprintf(log_file, "//Load comment \n");
        fprintf(log_file, "Memory Address in Load: %p\n", instance->w2c_host_mem);
