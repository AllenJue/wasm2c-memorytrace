...
static u32 w2c_rot13__big_f2(w2c_rot13__big*, u32);
static void w2c_rot13__big_rot13_0(w2c_rot13__big*);

FUNC_TYPE_T(w2c_rot13__big_t0) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";
FUNC_TYPE_T(w2c_rot13__big_t1) = "\x26\x10\x81\xe2\x21\x43\xd6\x01\x3e\x2d\x2f\x16\x17\x78\x6f\xba\xb3\x2f\x4d\x54\x9b\x8a\xa9\xdd\xbf\x53\x92\x3c\xd3\x71\xc6\xb2";
FUNC_TYPE_T(w2c_rot13__big_t2) = "\x07\x80\x96\x7a\x42\xf7\x3e\xe6\x70\x5c\x2f\xac\x83\xf5\x67\xd2\xa2\xa0\x69\x41\x5f\xf8\xe7\x96\x7f\x23\xab\x00\x03\x5f\x4a\x3c";
FUNC_TYPE_T(w2c_rot13__big_t3) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static void init_memories(w2c_rot13__big* instance) {
}

/* export: 'rot13' */
void w2c_rot13__big_rot13(w2c_rot13__big* instance) {
#if WASM_RT_USE_SEGUE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  w2c_rot13__big_rot13_0(instance);
#if WASM_RT_USE_SEGUE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_rot13__big* instance, struct w2c_host* w2c_host_instance) {
  instance->w2c_host_instance = w2c_host_instance;
  instance->w2c_host_mem = w2c_host_mem(w2c_host_instance);
}

const u64 wasm2c_rot13__big_min_host_mem = 1;
const u64 wasm2c_rot13__big_max_host_mem = 65536;
const u8 wasm2c_rot13__big_is64_host_mem = 0;

void wasm2c_rot13__big_instantiate(w2c_rot13__big* instance, struct w2c_host* w2c_host_instance) {
...
void wasm2c_rot13__big_free(w2c_rot13__big* instance) {
}
...
u32 w2c_rot13__big_f2(w2c_rot13__big* instance, u32 var_p0) {
  u32 var_l1 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = var_p0;
...
void w2c_rot13__big_rot13_0(w2c_rot13__big* instance) {
  ...
  var_L1: 
    ...
    var_i0 = var_l1;
    var_i1 = var_l1;
    printf("Memory Access in Load: %p\n", (void*)((u64)instance->w2c_host_mem + (u64)var_i1));
    var_i1 = i32_load8_u(instance->w2c_host_mem, (u64)(var_i1));
    var_i1 = w2c_rot13__big_f2(instance, var_i1);
    printf("Memory Access in Store: %p\n", (void*)((u64)instance->w2c_host_mem + (u64)var_i0));
    i32_store8(instance->w2c_host_mem, (u64)(var_i0), var_i1);
    var_i0 = var_l1;
    var_i1 = 1u;
    var_i0 += var_i1;
    var_l1 = var_i0;
  ...
  var_i0 = 0u;
  var_i1 = var_l0;
  w2c_host_buf_done(instance->w2c_host_instance, var_i0, var_i1);
  FUNC_EPILOGUE;
}
